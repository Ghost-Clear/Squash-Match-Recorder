...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="matchChooser",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12matchChooser11AppDelegate")
...
SWIFT_CLASS("_TtC12matchChooser13SceneDelegate")
...
SWIFT_CLASS("_TtC12matchChooser14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified currentPlayerLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified stringToMakeLabel2;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified stringToMakeLabel1;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified player1PointLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified player2PointLabel;
- (IBAction)switchPlayers:(id _Nonnull)sender;
- (void)viewDidLoad;
- (IBAction)playLet:(id _Nonnull)sender;
...
- (IBAction)deleteLast:(id _Nonnull)sender;
- (IBAction)pointToPlayer2:(id _Nonnull)sender;
- (IBAction)pointToPlayer1:(id _Nonnull)sender;
- (IBAction)finish:(id _Nonnull)sender;
